...
import { findApplications, insertApplication } from '@/api-lib/db';
...
handler.post(
  ...
  validateBody({
    ...
    properties: {
      ...
      lastname: ValidateProps.application.lastname,
      ...
      indigenefile: ValidateProps.application.indigenefile,
      residentialaddress: ValidateProps.application.residentialaddress,
      district: ValidateProps.application.district,
  ...
  async (req, res) => {
    ...
    const application = await insertApplication(db, {
      ...
      indigenefile: req.body.indigenefile,
      residentialaddress: req.body.residentialaddress,
      district: req.body.district,
      // landmark: req.body.landmark,
      qualification: req.body.qualification,
      insituition: req.body.insituition,
